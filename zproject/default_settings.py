...
NODL_SUPABASE_JWT_SECRET: str = os.environ.get("SUPABASE_JWT_SECRET", "")
...
NODL_SUPABASE_URL: str = os.environ.get("SUPABASE_URL", "")
...
NODL_SUPABASE_SERVICE_ROLE_KEY: str = os.environ.get("SUPABASE_KEY", "")
